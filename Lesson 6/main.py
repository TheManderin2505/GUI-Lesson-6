...
btn1 = Button(frame1, text = "Rock",bg = "grey",fg = "black",bd = 0, width = 15, command = NONE)
btn1.grid(row=1,column=1,padx=7,pady=7)

btn2 = Button(frame1, text = "Paper",bg = "white",fg = "black",bd = 0, width = 15, command = NONE)
btn2.grid(row=1,column=2,padx=7,pady= 7)

btn3=Button(frame1,text = "Scissors",bg = "light grey", fg = "black", bd = 0, width = 15, command = None)
